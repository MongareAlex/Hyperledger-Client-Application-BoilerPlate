...
function main(error){
    ...
    let participantkey= "participantid1";//hardcoded transaction values
    let Titledeedno="deedno1";//
    ...
    transaction.setPropertyValue('newOwnerParticipantkey', participantkey);
